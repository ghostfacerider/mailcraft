            ...
            <div className="card mb-4 box-shadow">
                ...
                <div className="card-body">
                    ...
                    <p className="card-text">
                        ...
                        Team City:{" "}
                        {player.currectTeam &&
                            player.currectTeam.team_city}{" "}
                        <br />
                        Team Name:{" "}
                        {player.currectTeam && player.currectTeam.team_name}
                    </p>
                    <p className="card-text">
                        Previous Team:
                        <br />
                        ...
                        <br />
                        Team Name:{" "}
                        {player.previousTeam && player.previousTeam.team_name}
                    </p>
                    <p className="card-text">
                        Country:
                        <br />
                        Country Code: {player.country &&
                            player.country.code}{" "}
                        <br />
